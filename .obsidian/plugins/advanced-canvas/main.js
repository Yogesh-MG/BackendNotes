...
var CanvasPatcher = class extends Patcher {
  async patch() {
    ...
    this.plugin.app.workspace.iterateAllLeaves(async (leaf) => {
      if (leaf.view.getViewType() !== "canvas")
        return;
      const canvasView2 = leaf.view;
      const currentData = canvasView2.getViewData();
      const savedData = canvasView2.file ? await this.plugin.app.vault.read(canvasView2.file) : null;
